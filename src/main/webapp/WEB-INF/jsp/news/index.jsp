...
<div class="main">
    ...
    <img src="301955_10151440835187561_2009460177_n.jpg" class="newsimg" />
    </a>
    <div class="media-body">
        
    <h4>How can I block my hosting service's advertisements?</h4>
       <p>Check the Terms of Service (TOS) agreement for your hosting service. It almost certainly prohibits interfering with the advertisements they add to your web pages. If you use some trick to block their advertisements on your own, then your hosting service may delete your account for violating its TOS. <a href="http://www.amref.org/news/news/international-day-of-the-midwife/">Read more</a></p>

       <h4>How can I get my own domain name?</h4>
									<p>The Internet Corporation for Assigned Names and Numbers (ICANN) maintains a list of accredited registrars . Any of the companies on this list can register a domain name for you.. <a href="http://www.amref.org/news/news/international-day-of-the-midwife/">Read more</a></p>

    </div>
    </div>
    </div>
                                          <div class="item item-3" style="background-image: url('/silo/images/esther-madudu-_100x100.jpg')"></div>
									...
									<p>These scripts annoy visitors who lose ready access to their browsers' normal context-menu functions (e.g., "Open in new window" or "Bookmark link"). These scripts can also interfere with features like mouse gestures.
	                                                                   ...
	                                                                   These scripts do nothing when JavaScript is disabled or unavailable, when JavaScript access to right-click events is disabled, on systems without mice, or on systems with single-button mice. <a href="http://www.amref.org/news/news/international-day-of-the-midwife/">Read more</a></p>
